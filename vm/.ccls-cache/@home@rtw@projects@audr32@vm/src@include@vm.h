...
enum {
    REG_AX              =           0x00,           // 32 bit accumulator register
    REG_BX              =           0x01,           // 32 bit base register
    REG_CX              =           0x02,           // 32 bit counter register
    REG_DX              =           0x03,           // 32 bit data register
    REG_SI              =           0x04,           // 32 bit source index register
    REG_DI              =           0x05,           // 32 bit destination index register
    REG_SP              =           0x06,           // 32 bit stack pointer register
    REG_BP              =           0x07,           // 32 bit base pointer register
    REG_IP              =           0x08,           // 32 bit instruction pointer register
    REG_R0              =           0x09,           // Generic 32 bit register
    REG_R1              =           0x0A,           // Generic 32 bit register
    REG_R2              =           0x0B,           // Generic 32 bit register
    REG_R3              =           0x0C,           // Generic 32 bit register
    REG_R4              =           0x0D,           // Generic 32 bit register
    REG_R5              =           0x0E,           // Generic 32 bit register
    REG_R6              =           0x0F,           // Generic 32 bit register
    REG_R7              =           0x10,           // Generic 32 bit register
    REG_R8              =           0x11,           // Generic 32 bit register
    REG_R9              =           0x12,           // Generic 32 bit register
    REG_R10             =           0x13,           // Generic 32 bit register
    REG_R11             =           0x14,           // Generic 32 bit register
    REG_R12             =           0x15,           // Generic 32 bit register
    REG_R13             =           0x16,           // Generic 32 bit register
    REG_R14             =           0x17,           // Generic 32 bit register
    REG_R15             =           0x18            // Generic 32 bit register
};
